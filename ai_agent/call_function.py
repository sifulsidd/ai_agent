...
def call_function(function_call_part, verbose=False):
    ...
    # dic = {"get_files_info": get_files_info, "get_file_content": get_file_content, "run_python_file": run_python_file, "write_file": write_file}
    
    # #  if the function call name is not in the dictionary, return an error
    # if function_call_part.name not in dic:
    ...
    # # we are calling the function with the working directory and the arguments
    # result = dic[function_call_part.name](working_directory, **function_call_part.args)
    result = ""
